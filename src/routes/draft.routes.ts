...
function firstVal(arr: any[], key: string) {
...
function extractPicks(draftJson: any, leagueKey?: string) {
...
function extractTeams(teamsJson: any) {
...
function extractBudget(settingsJson: any): number {
...
function computeBudgets(teams: any[], picks: any[], leagueBudget: number) {
